...
public class Test03 {
	...
	public static void main(String[] args) {
		...
		Car c3 = (Car)ctx.getBean("step01.Car");//같은 클래스의 인스턴스가 여러 개 있을 경어, 첫번째 빈을 가리킨다.]
