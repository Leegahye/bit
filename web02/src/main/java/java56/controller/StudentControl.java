...
public class StudentControl {
	...
	public String signup2(
		...
		//@SessionArrtibutes 에 선언한대로 student 이름으로 객체를 모델에 보관하면
		// 해당 객체는 세션에 보관될 것이다.
	...
	// => 요청 핸들러(요청이 들어왔을 때 호출되는 메서드)를 정의할 때,
	...
	public String signup3(
		...
		//굳이 모델에 저장할 필요가 없다. 왜냐하면 이미 sutdent 객체는 세션에 보관되어 있기 때문이다.
		//model.addAttribute("student",student);
	...
	public String signupComplete(
		...
		//setComplete()을 호출하면 클래스 상단에 지정한(@SessionAttribute(...)) 세션 보관 객체를 제거한다.
