...
/*
 * 가정!
 *  - 실제 요청을 처리할 페이지 컨트롤러는 ServletContext 보관함에 들어있다.
...
public class DispatcherServlet extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		//예) http://localhost:9999/web01/score/step5/list.do
		// getServletPath()의 리턴값 : /score/step5/list.do
		String pageUrl = request.getServletPath();
		
		//2. PageUrl로 ServletContext로 부터 페이지 컨트롤러 꺼낸다.
