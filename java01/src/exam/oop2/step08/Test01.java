 ...
 * 2. import 명령
 *  - 클래스의 경로를 컴파일러에게 제공하는 명령.
 */


// * 클래스의 경로 지정
// import는 컴파일러가 참고하는 정보이다. 따라서 컴파일 후 제거된다.
// import문이 많으면 컴파일한 후 바이트코드(.class)가 커진다는 착각을 하지 말 것!
...
public class Test01 {
	...
	public static void main(String[] args) {
		...
		// 	  ex) String, System,Object, ...
		
		//exam.oop2.step08.sub.A p1; //오류! A의 접근 제한자가 default이다.
		exam.oop2.step08.sub.B p; //성공! B의 접근 제한자는 public 이다.
		 ...
		 *  ex1) import.exam.oop2.step08.sub.A;
		 *  
		 *  클래스 이름을 빼고 패키지 이름만 지정할 수 있다.
		 *   ==> 해당 패키지에 있는 모든 클래스를 사용할 수 있다.
		 *  ex2) import.exam.oop2.step08.sub.*;
		 *  
		 *  권고 => 가능한 클래스 이름까지 지정하라! => 소스코드 읽을 때 빠르게 클래스의 경로를 파악할 수 있다.
		 */
		B p3;//improt문을 선언했기 때문에 패키지 명 생략가능!
	}
